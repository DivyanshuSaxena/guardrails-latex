...
\definecolor{rohitcolor}{rgb}{0.2, 0.7, 0.5}
% comments, etc.
\newcommand{\todo}[1]{}
\newcommand{\discuss}[1]{}
\newcommand{\cjr}[1]{}
...
\renewcommand{\discuss}[1]{{\color{orange}\textbf{Discuss:} #1}}
...
\renewcommand{\mike}[1]{{\color{purple}\textbf{[aditya]:} #1}}
\renewcommand{\jane}[1]{{\color{violet}\textbf{[jane]:} #1}}
\renewcommand{\rohit}[1]{{\color{rohitcolor}\textbf{[rohit]:} #1}}
\renewcommand{\sujay}[1]{{\color{brown}\textbf{[sujay]:} #1}}
\renewcommand{\yeonju}[1]{{\color{cyan}\textbf{[yeonju]:} #1}}
...
\small{Alternative: How I learned to stop worrying and love learned OS policies}}
