...
\begin{dslbox}[title={Guardrail~\theguardcount: CompactionOverhead}, glabel=lst:compaction-overhead]
for THPAlways
when periodic(10s)
...
\begin{dslbox}[title={Guardrail~\theguardcount: InDistributionShort}, glabel=lst:in-dist-short]
