...
An OS Guardrail (or guardrail, for simplicity) is a construct that evaluates whether the execution of an OS policy meets some target performance requirement.
...
\ds{Add a flow scheduling example here.}
